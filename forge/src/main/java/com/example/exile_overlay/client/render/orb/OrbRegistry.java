...
/**
 * HUD上の物理スロット位置に基づいてオーブを管理するレジストリ。
 * ORB_1: 左下メイン、ORB_1_OVERLAY: ORB_1に重なる、ORB_2: 右下メイン、ORB_3: 左上サブ。
 */
public class OrbRegistry {
    ...
    public static List<OrbType> getVisibleOrbs(Player player) {
        ...
        synchronized (visibleOrbsCache) {
            ...
            return new ArrayList<>(visibleOrbsCache);
        }
    }
