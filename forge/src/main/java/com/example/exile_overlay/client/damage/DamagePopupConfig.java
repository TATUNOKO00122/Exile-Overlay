...
public class DamagePopupConfig extends AbstractConfigSection {

    private static final String SECTION_ID = "damage_popup";
    private static final String FILE_NAME = "exile_overlay_damage_popup.json";
    ...
    private DamagePopupMode popupMode = DamagePopupMode.SPIRAL_SPREAD;

    private FontPreset fontPreset = FontPreset.GAME_POCKET;
    ...
    protected void deserialize(JsonObject obj) {
        ...
        if (obj.has("popupMode")) popupMode = DamagePopupMode.fromName(obj.get("popupMode").getAsString());
    ...
    protected void serialize(JsonObject obj) {
        ...
        obj.addProperty("popupMode", popupMode.name());
    ...
    public DamagePopupMode getPopupMode() { return popupMode; }
    ...
    public void setPopupMode(DamagePopupMode mode) { this.popupMode = mode != null ? mode : DamagePopupMode.SPIRAL_SPREAD; }
