...
public class ResourceCandidate {
    ...
    public ResourceCandidate(String id, String displayName, 
        ...
        this(id, displayName, valueGetter, maxValueGetter, color, null, showValue);
    }

    public ResourceCandidate(String id, String displayName, 
                            BiFunction<Player, DataType, Float> valueGetter,
                            BiFunction<Player, DataType, Float> maxValueGetter,
                            Supplier<Integer> colorSupplier, boolean showValue) {
        this(id, displayName, valueGetter, maxValueGetter, 0, colorSupplier, showValue);
    }

    public ResourceCandidate(String id, String displayName, 
                            BiFunction<Player, DataType, Float> valueGetter,
                            BiFunction<Player, DataType, Float> maxValueGetter,
                            int color, Supplier<Integer> colorSupplier, boolean showValue) {
        this.id = id;
