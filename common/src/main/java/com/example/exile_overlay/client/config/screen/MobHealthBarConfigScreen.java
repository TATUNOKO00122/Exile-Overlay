...
public class MobHealthBarConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        showHealthBarCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_healthbar"), config.isShowHealthBar());
        addRenderableWidget(showHealthBarCheckbox);
        leftY += SPACING;

        showPlayerHealthBarCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_player_healthbar"), config.isShowPlayerHealthBar());
        addRenderableWidget(showPlayerHealthBarCheckbox);
        leftY += SPACING;

        showForAllMobsCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_for_all_mobs"), config.isShowForAllMobs());
        addRenderableWidget(showForAllMobsCheckbox);
        leftY += SPACING;

        showOnlyWhenDamagedCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_only_when_damaged"), config.isShowOnlyWhenDamaged());
        addRenderableWidget(showOnlyWhenDamagedCheckbox);
        leftY += SPACING;

        showHealthValueCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_health_value"), config.isShowHealthValue());
        addRenderableWidget(showHealthValueCheckbox);
        leftY += SPACING;

        showMaxHealthCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_max_health"), config.isShowMaxHealth());
        addRenderableWidget(showMaxHealthCheckbox);
        leftY += SPACING;

        showPercentageCheckbox = new Checkbox(leftColumnX, leftY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_percentage"), config.isShowPercentage());
        addRenderableWidget(showPercentageCheckbox);

        // === 右カラム：サイズ設定 ===
        int rightY = startY;

        barWidthSlider = new SliderButton(rightColumnX, rightY, BUTTON_WIDTH, BUTTON_HEIGHT,
        ...
        barHeightSlider = new SliderButton(rightColumnX, rightY, BUTTON_WIDTH, BUTTON_HEIGHT,
        ...
        scaleSlider = new SliderButton(rightColumnX, rightY, BUTTON_WIDTH, BUTTON_HEIGHT,
        ...
        curveAmountSlider = new SliderButton(rightColumnX, rightY, BUTTON_WIDTH, BUTTON_HEIGHT,
        ...
        verticalOffsetSlider = new SliderButton(rightColumnX, rightY, BUTTON_WIDTH, BUTTON_HEIGHT,
        ...
        horizontalOffsetSlider = new SliderButton(rightColumnX, rightY, BUTTON_WIDTH, BUTTON_HEIGHT,
        ...
        showThroughWallsCheckbox = new Checkbox(rightColumnX, rightY, 180, BUTTON_HEIGHT,
                Component.translatable("checkbox.exile_overlay.show_through_walls"), config.isShowThroughWalls());
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        int leftColumnX = centerX - BUTTON_WIDTH - COLUMN_SPACING / 2;
        int rightColumnX = centerX + COLUMN_SPACING / 2;
        graphics.drawString(this.font, Component.translatable("label.exile_overlay.display_settings"), leftColumnX, 22, 0xAAAAAA);
        graphics.drawString(this.font, Component.translatable("label.exile_overlay.position_settings"), rightColumnX, 22, 0xAAAAAA);
